...
#Score and highscore count and system font 
high_score = 0
score = 0
font = pygame.font.SysFont("sans", 20)
#background image 
background_image = pygame.image.load("Background Cloud.png")
background_image = pygame.transform.scale(background_image, (WIDTH, HEIGHT))
bird_image = pygame.image.load("Bird photo.png")
...
while running:
    ...
    # score text black top left corner 
    score_txt = font.render("Score: " + str(score), True, BLACK)
    screen.blit(score_txt, (5, 5))

    #My name Developer Fahad Shaikh with copyright symbol White text 
    copyright_txt = font.render("© Fahad Shaikh", True, WHITE)
    screen.blit(copyright_txt, (WIDTH // 2 - copyright_txt.get_width() // 2, HEIGHT - 42))

    # Highscore text black top left corner 
    highscore_txt = font.render("High Score: " + str(high_score), True, BLACK)
    screen.blit(highscore_txt, (5, 30))
